...
abstract class MySQL
{
  ...
  public function getList($where = array(), $order = array(), $key = null)
  {
    $join = array();
    $leftJoin = '';
    ...
    $sql = 'SELECT '.implode(', ', $select).'
            FROM '.$this->table.' AS '.$this->table.$leftJoin.$w.$o;

    return Db::getInstance()->executeSelect($sql, $key);
  }
  ...
  public function removeColumnKey($key)
  {
    if (is_string($key))
